...
* [Передача на контроллер управляющей программы GCode](#cnc_gcode)
* [Подготовка и запуск управляющей программы GCode](#cnc_gcode_prepare)
* [Перемещение по оси](#axe)
* [Текущие координаты каретки станка](#coords)
* [Перемещение каретки станка на указанные координаты](#coord_target)
* [Поджиг дуги плазмы](#plasma_arc)
...
Номер строки имеет размер 2 байта, что означает максимальное количество строк исходного gcode 65535. Увеличение размера до 4 байт (до 16 млн. строк) возможно в следующих версиях.
